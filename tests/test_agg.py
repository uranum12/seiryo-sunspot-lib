...
def test_convert_number(
    ...
    df_out = agg.convert_number(df_in)
    assert_frame_equal(df_out, df_expected, check_column_order=False)
...
def test_convert_coord(
    ...
    df_out = agg.convert_coord(df_in, col=in_col, dtype=in_dtype)
    assert_frame_equal(df_out, df_expected, check_column_order=False)
